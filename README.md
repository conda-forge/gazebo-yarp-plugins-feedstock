About gazebo-yarp-plugins-feedstock
===================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gazebo-yarp-plugins-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gazebo-yarp-plugins-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gazebo-yarp-plugins libgazebo-yarp-plugins
# for installing globally
pixi global install gazebo-yarp-plugins libgazebo-yarp-plugins
```
...
It is possible to list all of the versions of `gazebo-yarp-plugins` available on your platform:
...
```
pixi search gazebo-yarp-plugins --channel conda-forge
```
